...
menage_2002 <- menage_2002 %>% 
  left_join(
    ...
    rename(
      ...
      select(ID_MENAGE, num_men, DR, niveau_instruction_cm, sexe_cm, age_cm, school_attendance),
...
menage_2013 <- menage_2013 %>% 
  ...
  rename(
    ...
    age_cm = B08,         # Renamed B08 to "age_cm"
      ...
      # Selecting specific columns from the filtered dataset
      select(ID_MENAGE, IDDR, niveau_instruction_cm, sexe_cm, age_cm, school_attendance),
...
deces_2002 <- deces_2002 %>% 
  ...
  mutate(deces_under_five = ifelse(nbr_deces_under_five > 0, 1, 0))

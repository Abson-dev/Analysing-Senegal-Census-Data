...
```{=html}
<div id="zgswumbokx" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#zgswumbokx table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#zgswumbokx thead, #zgswumbokx tbody, #zgswumbokx tfoot, #zgswumbokx tr, #zgswumbokx td, #zgswumbokx th {
  border-style: none;
}
...
#zgswumbokx .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#zgswumbokx .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#zgswumbokx .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#zgswumbokx .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#zgswumbokx .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#zgswumbokx .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#zgswumbokx .gt_spanner_row {
  border-bottom-style: hidden;
}

#zgswumbokx .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zgswumbokx .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#zgswumbokx .gt_from_md > :first-child {
  margin-top: 0;
}

#zgswumbokx .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#zgswumbokx .gt_row_group_first td {
  border-top-width: 2px;
}

#zgswumbokx .gt_row_group_first th {
  border-top-width: 2px;
}

#zgswumbokx .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#zgswumbokx .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#zgswumbokx .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#zgswumbokx .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zgswumbokx .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#zgswumbokx .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zgswumbokx .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#zgswumbokx .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#zgswumbokx .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#zgswumbokx .gt_font_normal {
  font-weight: normal;
}

#zgswumbokx .gt_font_bold {
  font-weight: bold;
}

#zgswumbokx .gt_font_italic {
  font-style: italic;
}
...
#zgswumbokx .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#zgswumbokx .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#zgswumbokx .gt_indent_1 {
  text-indent: 5px;
}

#zgswumbokx .gt_indent_2 {
  text-indent: 10px;
}

#zgswumbokx .gt_indent_3 {
  text-indent: 15px;
}

#zgswumbokx .gt_indent_4 {
  text-indent: 20px;
}

#zgswumbokx .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
```r
edu_var = c("nbr_educ_primaire","nbr_educ_moyen","nbr_educ_secondaire","nbr_educ_superieur")
...
menage_2002 <- menage_2002 %>% 
  ...
  mutate(
    ...
    # Create a new variable "nbr_piece_occup" as a factor with labels from the "menage_2002" dataset
...
# Create a new variable "nbr_piece_occup" as a factor with labels from the "menage_2013" dataset
...
deces_2002 <- deces_2002 %>% 
  ...
  summarise(
    ...
    nbr_deces_under_five = sum(est_decedee==1 & C04 <=5,
                                       na.rm = TRUE)) %>% 
  ungroup() %>% 
  ...
  left_join(
    ...
    individus_2002 %>% 
      ...
      mutate(niveau_instruction_cm = QB15 %>% structure(label=paste0(Hmisc::label(individus_2002$QB15), " CM")),
          ...
          sexe_cm = QB04 %>% structure(label= paste0(Hmisc::label(individus_2002$QB04), " CM")),
          
          # Creating the "age_cm" variable from QB06 column
          age_cm = QB06 %>% structure(label=paste0(Hmisc::label(individus_2002$QB06), " CM"))) %>% 
  ...
  left_join(
    ...
    individus_2013 %>% 
      ...
      # Creating the "sexe_cm" variable from B06 column
          sexe_cm = B06 %>% structure(label= paste0(Hmisc::label(individus_2013$B06), " CM")),
          
          # Creating the "age_cm" variable from QB08 column
          age_cm = B08 %>% structure(label=paste0(Hmisc::label(individus_2013$B08), " CM"))) %>% 
      # Selecting specific columns from the filtered dataset
...
## For RGPH 2013
individus_2002 <- individus_2002 %>%
 select(ID_MENAGE, RGPH, everything())#id_dr, 

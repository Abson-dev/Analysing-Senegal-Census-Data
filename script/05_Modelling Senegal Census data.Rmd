...
label_to_remove = c("Id dr","Region","Dept.","Nom Arr.","Nom CA","RGPH","Nombre d'homme","Taille ménage","Taille ménage","Niveau d'instruction: Aucun","Nombre de French dans le ménage","Nombre de résident permanent","Nombre de CM de sexe masculin","Proportion de CM de sexe masculin","geometry")
